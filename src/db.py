...
class Database:
    ...
    # ========== Predictions Methods (SPEC-05 B7) ==========
    # Logs (predicted_probability, outcome) pairs so the log-odds model can be
    # calibrated against real results (scripts/calibrate_model.py). Table
    # created by alembic/versions/2551bbcc9eb8_add_predictions_table.py.
