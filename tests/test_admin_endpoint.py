...
class TestAdminEndpoint:
    ...
    def test_without_api_key(self, mock_settings):
        ...
        """
        # Configure mock settings with valid admin API key
        mock_settings.admin_api_key = self.valid_api_key
    ...
    @patch("server.src.api.routes.admin.settings")
    def test_with_invalid_api_key(self, mock_settings):
    ...
    @patch("server.src.api.routes.admin.settings")
    def test_with_empty_api_key(self, mock_settings):
    ...
    def test_with_valid_api_key(self, mock_close_connections, mock_settings):
    ...
    @patch("server.src.api.routes.admin.settings")
    @patch("server.src.api.routes.admin.close_all_connections", new_callable=AsyncMock)
    def test_exception_during_refresh(self, mock_close_connections, mock_settings):
