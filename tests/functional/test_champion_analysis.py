...
class TestChampionAnalysisNonRegression:
    ...
    def test_tierlist_delta2_method_exists(self, assistant):
        ...
        assert hasattr(assistant, "tierlist_delta2"), "Assistant must have tierlist_delta2 method"
        assert callable(assistant.tierlist_delta2), "tierlist_delta2 must be callable"
