...
| D4 | ✅ Purger les emojis des sorties console — sauf `pipeline.py`/`notifications.py` (notifications Discord/toast, exemptées : usage visuel, pas de la console de dev) | 3 | 2 | 1,5 |
